    ...
    <div className="legal-container">
      ...
      <div className="legal-section">
        ...
        <ul>
          ...
          <li><strong>Payment Data:</strong> Payment processing is handled by PayPal. We do not store your full card or bank details on our local servers.</li>
        </ul>
      </div>
      ...
      <div className="legal-section">
        ...
        <p>
          ...
          recurring monthly charges via PayPal. Fees are generally non-refundable. We reserve the right 
